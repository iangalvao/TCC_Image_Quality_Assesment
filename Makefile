...
run:
	docker run --rm -p 8888:8888 -v $$(pwd)/notebooks/:/home/jovyan/notebooks/  -v $$(pwd)/sample_data/1024x768/:/home/jovyan/sample_data/1024x768/ iqa_mac0499 jupyter notebook
